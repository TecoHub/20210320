...
<script type="text/javascript">
    ...
    frm.submit(function (e) {
        ...
        $.ajax({
          	url: "../works/discount_info.php", // Url to which the request is send
	...
	<body>
			...
			<form action="clients/addStudentInfo.php" name="contactForm1"  id="contactForm1" method="POST" style="margin-left:2%">
				...
				<h1>Set discount</h1>
					...
					<tr>
						<td>Discount_name</td>
						<td><input type="text" name="discount_name" id="discount_name" size="30" value="<?php echo$dataarr[0]['discount_name'] ?>" required></td>
					</tr> 


					<tr>
						<td> Percentage</td> 
						<td><input type="number" name="disc_per" id="disc_per" size="30" value="<?php echo$dataarr[0]['disc_per'] ?>" required></td>
					</tr>
					<!--<tr>
						<td> State </td> 
...
-->
		...
		<div style="margin-top: 20px;">
				...
				<tr style="background:#76BAC5; font-size:16px;"><th style="padding-left:20px;">Ref.No </th><th>name</th><th>percentage</th><th>active</th> <th>削除</th> </tr>
