...
<!----------------------------------Top Menu------------------------------------->
                           ...
                           <!--Change User-->
                           <area target="" alt="" title="" href="index.php?r=<?php echo$_SESSION['r'];?>" coords="220,10,281,62" shape="rect">

                           <!--Home-->
                           <area target="" alt="" title="" href="menu01.php?r=<?php echo$_SESSION['r'];?>" coords="285,10,329,62" shape="rect">

                           <!--History-->
                           <area target="" alt="" title="" href="order01.php?r=<?php echo$_SESSION['r'];?>" coords="334,10,378,62" shape="rect">
                                                                                                      ...
                                                                                                      <?php 
                                                                                                          ...
                                                                                                          echo "<option value=".$bl.">  ".$dataarr[$t]['bot_name']."
                                                                                                            ...
                                                                                                            if($dataarr[$t]['glass_price']>0){
                                                                                                              echo "  <option value=".$gl.">  ".$dataarr[$t]['gla_name']."
                                                                                                                </option>";
                                                                                                          }
                                                                                                      ?>
